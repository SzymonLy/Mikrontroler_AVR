...
// read addresses
#define DPU0	_SFR_IO8(0x00)
#define DPU1	_SFR_IO8(0x01)
#define DPU2	_SFR_IO8(0x02)
#define DPU3	_SFR_IO8(0x03)
#define DPU4	_SFR_IO8(0x04)
#define DPU5	_SFR_IO8(0x05)
#define DPU6	_SFR_IO8(0x06)
#define DPU7	_SFR_IO8(0x07)
...
#define INTER_MESS_DPU_0            _VECTOR(3)
#define INTER_MESS_DPU_1            _VECTOR(4)
#define INTER_MESS_DPU_2            _VECTOR(5)
#define INTER_MESS_DPU_3            _VECTOR(6)
#define INTER_MESS_DPU_4            _VECTOR(7)
#define INTER_MESS_DPU_5            _VECTOR(8)
#define INTER_MESS_DPU_6            _VECTOR(9)
#define INTER_MESS_DPU_7            _VECTOR(10)
#define INTER_MESS_DPU_8            _VECTOR(11)
